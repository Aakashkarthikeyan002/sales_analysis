...
class sql:
    ...
    def create_table():
        ...
        try:
            ...
            Akash = psycopg2.connect(host='localhost',
                                    user='postgres',
                                    password='0161',
    ...
    def data_migration():
        ...
        try:
            f = pd.read_csv(r'C:\Users\Admin\OneDrive\Desktop\final project\dataset\df_sql.csv')
            df = pd.DataFrame(f)
    ...
    def predict_weekly_sales():
        ...
        if button:
            with st.spinner(text='Processing...'):
                ...
                with open(r'C:\Users\Admin\OneDrive\Desktop\final project\model1_markdown.pkl', 'rb') as f:
                    model = pickle.load(f)
